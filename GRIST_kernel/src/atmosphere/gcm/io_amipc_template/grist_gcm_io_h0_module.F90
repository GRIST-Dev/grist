...
!
  ...
  fname_output="GRIST.ATM."//trim(grid_info)//"."//&
                              trim(working_mode)//".MonAvg."//&
                              trim(cyear)//"-"//&
                              trim(cmon)//".2d.h0.nc"
...
! output
  ...
  call wrap_add_field_2d(diag_physics_vars_h0%uwind           ,"u"             )
  call wrap_add_field_2d(diag_physics_vars_h0%vwind           ,"v"             )
  call wrap_add_field_2d(diag_physics_vars_h0%omega           ,"omega"         )
  call wrap_add_field_2d(diag_physics_vars_h0%phi             ,"geopotential"  )
  call wrap_add_field_2d(diag_physics_vars_h0%temp            ,"temperature"   )
  call wrap_add_field_2d(diag_physics_vars_h0%qv              ,"qv"            )
  call wrap_add_field_2d(diag_physics_vars_h0%qc              ,"qc"            )
  call wrap_add_field_2d(diag_physics_vars_h0%qi              ,"qi"            )
  call wrap_add_field_2d(diag_physics_vars_h0%rh              ,"relhum"        )
  call wrap_add_field_2d(diag_physics_vars_h0%cld             ,"cloud"         )
  call wrap_add_field_2d(diag_physics_vars_h0%concld             ,"concld"         )
  call wrap_add_field_2d(diag_physics_vars_h0%lwc             ,"lwc"         )
  call wrap_add_field_2d(diag_physics_vars_h0%iwc             ,"iwc"         )

  if(allocated(diag_physics_vars_h0%sgm%f)) call wrap_add_field_2d(diag_physics_vars_h0%sgm, "sgm")
...
! output
  ...
  call wrap_add_field_1d(pstate%landfrac_at_pc_surface            , "lndfrac")
  call wrap_add_field_1d(diag_physics_vars_h0%ps                     , "ps"      )
  call wrap_add_field_1d(diag_physics_vars_h0%ts                     , "ts"      )
  call wrap_add_field_1d(diag_physics_vars_h0%snowh                  , "snowh"   )
  call wrap_add_field_1d(diag_physics_vars_h0%shflx                  , "shflx"   )
  call wrap_add_field_1d(diag_physics_vars_h0%qflx                   , "qflx"    )
  call wrap_add_field_1d(diag_physics_vars_h0%prect                  , "prect"   )
  call wrap_add_field_1d(diag_physics_vars_h0%precc                  , "precc"   )
  call wrap_add_field_1d(diag_physics_vars_h0%precl                  , "precl"   )
  ...
  call wrap_add_field_1d(diag_physics_vars_h0%cldtot                 , "cldtot"  ) 
  call wrap_add_field_1d(diag_physics_vars_h0%cldlow                 , "cldlow"  ) 
  call wrap_add_field_1d(diag_physics_vars_h0%cldmed                 , "cldmed"  ) 
  call wrap_add_field_1d(diag_physics_vars_h0%cldhgh                 , "cldhgh"  ) 
  call wrap_add_field_1d(diag_physics_vars_h0%flwut                  , "flwut"   ) 
  call wrap_add_field_1d(diag_physics_vars_h0%flwdt                  , "flwdt"   )
  call wrap_add_field_1d(diag_physics_vars_h0%flwus                  , "flwus"   )
  call wrap_add_field_1d(diag_physics_vars_h0%flwds                  , "flwds"   )
  call wrap_add_field_1d(diag_physics_vars_h0%flwutc                 , "flwutc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%flwdtc                 , "flwdtc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%flwusc                 , "flwusc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%flwdsc                 , "flwdsc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%fswut                  , "fswut"   ) 
  call wrap_add_field_1d(diag_physics_vars_h0%fswdt                  , "fswdt"   )
  call wrap_add_field_1d(diag_physics_vars_h0%fswus                  , "fswus"   )
  call wrap_add_field_1d(diag_physics_vars_h0%fswds                  , "fswds"   )
  call wrap_add_field_1d(diag_physics_vars_h0%fsntoa                 , "fsntoa"  )
  call wrap_add_field_1d(diag_physics_vars_h0%fswutc                 , "fswutc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%fswdtc                 , "fswdtc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%fswusc                 , "fswusc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%fswdsc                 , "fswdsc"  )
  call wrap_add_field_1d(diag_physics_vars_h0%fsntoac                , "fsntoac" )
  call wrap_add_field_1d(diag_physics_vars_h0%lwcf                   , "lwcf"    )
  call wrap_add_field_1d(diag_physics_vars_h0%swcf                   , "swcf"    )
  call wrap_add_field_1d(diag_physics_vars_h0%tmq                    , "tmq"     )
  call wrap_add_field_1d(diag_physics_vars_h0%lwp                    , "lwp"     )
  call wrap_add_field_1d(diag_physics_vars_h0%iwp                    , "iwp"     )
  call wrap_add_field_1d(diag_physics_vars_h0%taux                   , "taux"    )
  call wrap_add_field_1d(diag_physics_vars_h0%tauy                   , "tauy"    )
